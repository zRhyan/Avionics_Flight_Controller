...
void main(void){
    ...
    while(1) { // Loop principal do controlador
        ...
        /*
        // Enquanto não estiver no COASTING (cycles_2 == -1), apenas preenche [0], [1] e [2]
        if(cycles_2 == -1) memory_bar[cycles_1%3] = data.pressure; // Apenas [0], [1] e [2]
        ...
        */
        ...
        switch (current_state){
            ...
            case STATE_COASTING:
                ...
                else {memory_bar[0] += delta_H_limit;}
